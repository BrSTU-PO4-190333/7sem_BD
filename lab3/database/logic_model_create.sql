...
CREATE SEQUENCE public.de_ctl_symptoms_id_seq1;

CREATE TABLE public.DE_CTL_Symptoms (
                id INTEGER NOT NULL DEFAULT nextval('public.de_ctl_symptoms_id_seq1'),
                de_name VARCHAR(32) NOT NULL,
                CONSTRAINT de_ctl_symptoms_pk PRIMARY KEY (id)
);


ALTER SEQUENCE public.de_ctl_symptoms_id_seq1 OWNED BY public.DE_CTL_Symptoms.id;
...
CREATE TABLE public.DE_CTL_Patients (
                ...
                de_patronymic VARCHAR(32),
                de_birthday DATE,
                de_address VARCHAR(128) NOT NULL,
...
ALTER TABLE public.DE_TAB_InspectionSymptoms ADD CONSTRAINT de_ctl_symptoms_de_tab_inspectionsymptoms_fk
FOREIGN KEY (de_symptomId)
