...
const ru_patronymics_man = require("./../../data/ru_patronymics_man.json");
const ru_patronymics_woman = require("./../../data/ru_patronymics_woman.json");
const cities = require("./../../data/cities.json");

function main() {
  let sql = "";
  sql +=
    "INSERT INTO ГП_СПР_Студенты (гп_курс, гп_университетКод, гп_фамилия, гп_имя, гп_отчество, гп_стипендия, гп_городКод, гп_деньРождения) VALUES \n";
  ...
  for (let i = 0; i < university.length; ++i) {
    ...
    for (let j = 0; j < len; ++j) {
      ...
      const de_patronymic = ru_patronymics_man[getRandomIntInclusive(1, ru_patronymics_man.length)];
      ...
      sql += `(${de_course}, ${de_universityId}, '${de_surname}', '${de_name}', '${de_patronymic}', ${de_scholarship}, ${de_cityId}, '${de_birthday}'), \n`;
    }
    ...
    for (let j = 0; j < len; ++j) {
      ...
      const de_patronymic = ru_patronymics_woman[getRandomIntInclusive(1, ru_patronymics_woman.length)];
      const de_scholarship = getRandomIntInclusive(0, 1) == 0 ? "NULL" : 100;
  ...
  saveFile("./../sql/init/4__DE_CTL_Students.sql", sql);
}
