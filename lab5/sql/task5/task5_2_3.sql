...
DROP TRIGGER IF EXISTS ГП_ТРГР_СчетСреднегоБаллаУнивераПриУдаленииОтметки;

CREATE TRIGGER ГП_ТРГР_СчетСреднегоБаллаУнивераПриУдаленииОтметки 
AFTER DELETE ON ГП_ДОК_ЭкзамОтметки FOR EACH ROW BEGIN 
